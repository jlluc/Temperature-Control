...
void Update_Screen(void)
{
    ...
    time[0]  = (hour>>4)      + '0';         // First digit of hour
    time[1]  = (hour & 0x0f)  + '0';         // Second digit of hour
    time[3]  = (minute >> 4)  + '0';         // First digit of minute
    time[4]  = (minute & 0x0f)+ '0';         // Second digit of minute
    time[6]  = (second >> 4)  + '0';         // First digit of second
    time[7]  = (second & 0x0f)+ '0';         // First digit of second
    date[0]  = (month >> 4)   + '0';         // First digit of month
    date[1]  = (month & 0x0F) + '0';         // Second digit of month
    date[3]  = (day >> 4)     + '0';         // First digit of day
    date[4]  = (day & 0x0F)   + '0';         // Second digit of day
    date[6]  = (year >> 4)    + '0';         // First digit of year
    date[7]  = (year & 0x0F)  + '0';         // Second digit of year
    alarm_time[0]  = (alarm_hour>>4)  + '0';        // First digit of Alarm Hour MSD
    alarm_time[1]  = (alarm_hour & 0x0f)+ '0';      // Second digit of Alarm Hour MSD
    alarm_time[3]  = (alarm_minute>>4) + '0';       // First digit of Alarm minute MSD
    alarm_time[4]  = (alarm_minute & 0x0f)+ '0';    // Second digit of Alarm minute MSD
    alarm_time[6]  = (alarm_second>>4) + '0';       // First digit of Alarm second MSD
    alarm_time[7]  = (alarm_second & 0x0f)+ '0';    // Second digit of Alarm second MSD
    ...
    Fan_Set_Temp_Txt[1] = setup_fan_temp%100 / 10 + '0';
