...
SOURCEFILES_QUOTED_IF_SPACED=Interrupt.c Main.c Main_Screen.c Setup_Alarm_Time.c Setup_Fan_Temp.c Setup_Time.c I2C_Soft.c I2C_Support.c TFT_ST7735.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/Interrupt.p1 ${OBJECTDIR}/Main.p1 ${OBJECTDIR}/Main_Screen.p1 ${OBJECTDIR}/Setup_Alarm_Time.p1 ${OBJECTDIR}/Setup_Fan_Temp.p1 ${OBJECTDIR}/Setup_Time.p1 ${OBJECTDIR}/I2C_Soft.p1 ${OBJECTDIR}/I2C_Support.p1 ${OBJECTDIR}/TFT_ST7735.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/Interrupt.p1.d ${OBJECTDIR}/Main.p1.d ${OBJECTDIR}/Main_Screen.p1.d ${OBJECTDIR}/Setup_Alarm_Time.p1.d ${OBJECTDIR}/Setup_Fan_Temp.p1.d ${OBJECTDIR}/Setup_Time.p1.d ${OBJECTDIR}/I2C_Soft.p1.d ${OBJECTDIR}/I2C_Support.p1.d ${OBJECTDIR}/TFT_ST7735.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/Interrupt.p1 ${OBJECTDIR}/Main.p1 ${OBJECTDIR}/Main_Screen.p1 ${OBJECTDIR}/Setup_Alarm_Time.p1 ${OBJECTDIR}/Setup_Fan_Temp.p1 ${OBJECTDIR}/Setup_Time.p1 ${OBJECTDIR}/I2C_Soft.p1 ${OBJECTDIR}/I2C_Support.p1 ${OBJECTDIR}/TFT_ST7735.p1

# Source Files
SOURCEFILES=Interrupt.c Main.c Main_Screen.c Setup_Alarm_Time.c Setup_Fan_Temp.c Setup_Time.c I2C_Soft.c I2C_Support.c TFT_ST7735.c
...
dist/${CND_CONF}/${IMAGE_TYPE}/Lab_Final.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/Lab_Final.X.${IMAGE_TYPE}.map  -D__DEBUG=1  --debugger=pickit3  --double=24 --float=24 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     --rom=default,-fd30-ffff --ram=default,-ef4-eff,-f9c-f9c,-fd4-fd4,-fdb-fdf,-fe3-fe7,-feb-fef,-ffd-fff  $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/Lab_Final.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -DXPRJ_default=$(CND_CONF) 
	@${RM} dist/${CND_CONF}/${IMAGE_TYPE}/Lab_Final.X.${IMAGE_TYPE}.hex 
	
else
dist/${CND_CONF}/${IMAGE_TYPE}/Lab_Final.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE) --chip=$(MP_PROCESSOR_OPTION) -G -mdist/${CND_CONF}/${IMAGE_TYPE}/Lab_Final.X.${IMAGE_TYPE}.map  --double=24 --float=24 --emi=wordwrite --opt=+asm,+asmfile,-speed,+space,-debug --addrqual=ignore --mode=free -P -N255 --warn=-3 --asmlist -DXPRJ_default=$(CND_CONF)  --summary=default,-psect,-class,+mem,-hex,-file --output=default,-inhx032 --runtime=default,+clear,+init,-keep,-no_startup,-download,+config,+clib,+plib --output=-mcof,+elf:multilocs --stack=compiled:auto:auto:auto "--errformat=%f:%l: error: (%n) %s" "--warnformat=%f:%l: warning: (%n) %s" "--msgformat=%f:%l: advisory: (%n) %s"     $(COMPARISON_BUILD) --memorysummary dist/${CND_CONF}/${IMAGE_TYPE}/memoryfile.xml -odist/${CND_CONF}/${IMAGE_TYPE}/Lab_Final.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX}  ${OBJECTFILES_QUOTED_IF_SPACED}      -DXPRJ_default=$(CND_CONF) 
